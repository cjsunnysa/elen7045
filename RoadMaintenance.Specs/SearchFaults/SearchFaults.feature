...
Scenario: Find open and recently closed faults by suburb name
	...
	| 2  | Hill Street | Malabongwe Drive | Sandton  | 2196     | 1        | 2      | 2015-03-01    |
	| 3  | Hill Street | Malabongwe Drive | Sandton  | 2196     | 1        | 2      | 2015-03-02    |
	| 4  | Hill Street | Malabongwe Drive | Sandton  | 2196     | 4        | 2      | 2015-03-01    |
	| 5  | Hill Street | Malabongwe Drive | Sandton  | 2196     | 4        | 2      | 2015-03-02    |
...
Scenario: Find open and recently closed faults by street and cross street
	...
	And   These faults exist
	| Id | Street      | CrossStreet | Suburb   | PostCode | StatusId | TypeId | DateCompleted |
	| 01  | Hill Street | Fern Ave    | Randburg | 2194     | 1        | 1      |               |
	| 02  | Fern Ave    | Hill Street | Randburg | 2194     | 1        | 1      |               |
	| 03  | Hill Street |             | Randburg | 2194     | 1        | 1      |               |
	| 05  | Fern Ave    |             | Randburg | 2194     | 1        | 1      |               |
	| 07  | Hill Street | Fern Ave    | Randburg | 2194     | 4        | 1      | 2015-03-01    |
	| 08  | Hill Street | Fern Ave    | Randburg | 2194     | 4        | 1      | 2015-03-02    |
	| 09  | Fern Ave    | Hill Street | Randburg | 2194     | 4        | 1      | 2015-03-01    |
...
Scenario: Find open and recently closed faults by street and cross street and fault type and suburb name
	...
	| Id | Street      | CrossStreet | Suburb   | PostCode | StatusId | TypeId | DateCompleted |
	| 01 | Hill Street | Fern Ave    | Randburg | 2194     | 1        | 1      |               |
	| 02 | Fern Ave    | Hill Street | Sandton  | 2196     | 1        | 1      |               |
	| 03 | Hill Street |             | Randburg | 2194     | 1        | 1      |               |
	| 05 | Fern Ave    |             | Randburg | 2194     | 1        | 1      |               |
	| 07 | Hill Street | Fern Ave    | Randburg | 2194     | 4        | 1      | 2015-03-01    |
	| 08 | Hill Street | Fern Ave    | Randburg | 2194     | 4        | 1      | 2015-03-02    |
